...
# 8 photos per location (360 / 45 = 8 headings)
...
for index, row in df.iterrows():
    ...
    # range(0, 360, 45) creates: [0, 45, 90, 135, 180, 225, 270, 315]
    for current_heading in range(0, 360, 45):
        ...
        if response.status_code == 200:
            ...
            print(f"[{index + 1}/{len(df)}] No imagery at {lat}, {lng} heading {current_heading}° (404).")
